...
public class Textures {
    ...
    public enum Ui implements TextureId {
        CLOCK_FACE, CLOSE_BUTTON, FUNGUS, HOME, HOUR_HAND, HOUSE, MINUTE_HAND, NPC, SERVICE, WORKPLACE, NO_STORAGE, FULL_STORAGE, NO_RESOURCES, WORK, REST, STORAGE, CONSTRUCTION_OFFICE, WINDOW
    }

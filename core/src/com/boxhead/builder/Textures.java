...
public class Textures {
    ...
    public enum Ui implements TextureId {
        FUNGUS, HOME, HOUSE, NPC, SERVICE, WORKPLACE, NO_STORAGE, FULL_STORAGE, NO_RESOURCES, WORK, REST, DEMOLISH, STORAGE, CONSTRUCTION_OFFICE, WINDOW,
        CLOCK_FACE, HOUR_HAND, MINUTE_HAND, PAUSE, PLAY, X2SPEED, X3SPEED,
        WIDE_BUTTON, CLOSE_BUTTON
    }

...
public class Textures {
    ...
    public enum Ui implements TextureId {
        SMALL_BUTTON, BIG_BUTTON, WINDOW, MENU_WINDOW, WIDE_AREA,
        CLOSE_BUTTON, TEXT_FIELD, WIDE_TEXT_FIELD, LEFT_ARROW, RIGHT_ARROW,

        FULL_OUTPUT, NO_INPUT, SHIFT_DIVIDER,

        FUNGUS, HAMMER, NPC, WORK, REST, DEMOLISH, SHIFTS, PAUSE_GAME,
        ...
        PATH, CROSS, BOOK, COW, BUILD,

        SAVE, LOAD, DELETE,

        TIMELINE_SEGMENT, TIMELINE_TOP, CHECK_BOX, CHECK
    }

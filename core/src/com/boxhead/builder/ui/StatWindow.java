...
public abstract class StatWindow<T extends GameObject> extends Window {
    ...
    protected void updatePosition() {
        Vector3 objectPosition = BuilderGame.getGameScreen().getCamera().project(new Vector3(pinnedObject.getGridPosition().x * World.TILE_SIZE, pinnedObject.getGridPosition().y * World.TILE_SIZE, 0));
